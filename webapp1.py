...
def fetch_calories(prediction):
    cal_list={0: 'Aloo Paratha', 1: 'Dahi Bhalla', 2: 152, 3: 168 , 4: 40, 5: 44, 6: 'Poha', 7: 130, 8: 209, 9: 'Vada Pav', 10: 'Vada'}
    cal=0
    for i in prediction:
        cal=cal+cal_list[i]
    print('cal ',cal)
...
def upload_image():
    ...
    if file and allowed_file(file.filename):
        ...
        yolo=YOLO('best.pt')
        result=yolo.predict(filepath, save=True, imgsz=640)
